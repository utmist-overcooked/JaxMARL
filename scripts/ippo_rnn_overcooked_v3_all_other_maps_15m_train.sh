...
SWEEP_TAG="${SWEEP_TAG:-rnn_order_visible_plateguard_burn40_15m}"
SWEEP_PROJECT="${SWEEP_PROJECT:-overcookedv3_ippo_rnn_all_other_maps_${SWEEP_TAG}_${SWEEP_ID}}"
SWEEP_DIR="${SWEEP_DIR:-$ROOT_DIR/outputs/v3_rnn_map_sweep_${SWEEP_TAG}_${SWEEP_ID}}"
...
echo "Starting Overcooked V3 all-other-layouts IPPO RNN sweep"
