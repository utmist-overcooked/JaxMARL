...
SWEEP_TAG="${SWEEP_TAG:-hardcoop_rnn_order_visible_plateguard_burn40_15m_max1500}"
SWEEP_PROJECT="${SWEEP_PROJECT:-overcookedv3_ippo_rnn_hardcoop_${SWEEP_TAG}_${SWEEP_ID}}"
SWEEP_DIR="${SWEEP_DIR:-$ROOT_DIR/outputs/v3_rnn_hardcoop_sweep_${SWEEP_TAG}_${SWEEP_ID}}"
...
echo "Starting Overcooked V3 hard-cooperation IPPO RNN sweep"
echo "Sweep id: $SWEEP_ID"
echo "W&B project: $SWEEP_PROJECT"
echo "Sweep dir: $SWEEP_DIR"
echo "Total timesteps per layout: $TOTAL_TIMESTEPS"
echo "Max episode steps: $MAX_STEPS"
