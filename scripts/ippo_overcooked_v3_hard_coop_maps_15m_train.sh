...
SWEEP_TAG="${SWEEP_TAG:-hardcoop_order_visible_plateguard_burn40_15m_max1500}"
SWEEP_PROJECT="${SWEEP_PROJECT:-overcookedv3_ippo_cnn_hardcoop_${SWEEP_TAG}_${SWEEP_ID}}"
SWEEP_DIR="${SWEEP_DIR:-$ROOT_DIR/outputs/v3_hardcoop_sweep_${SWEEP_TAG}_${SWEEP_ID}}"
...
echo "Starting Overcooked V3 hard-cooperation IPPO CNN sweep"
