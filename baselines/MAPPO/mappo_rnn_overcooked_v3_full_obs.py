...
class ScannedRNN(nn.Module):
    ...
    `jax.api_util.debug_info`). Input projections (Dense) are computed for all
    timesteps outside the scan; recurrent weights are raw params applied inside
    `jax.lax.scan`. Interface unchanged:
